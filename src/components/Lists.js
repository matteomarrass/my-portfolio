...
const lingue = new Studies('Livello di lingue', '🇮🇹: Madrelingua', '🇬🇧: B2 (Livello certificato IELTS)', '🇪🇸: B2 (livello conversazionale)')

export {developer, factory, codecademy, ipsia, lingue};
